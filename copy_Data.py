...
def copy_file():
    data, nf = data_file()
    answer = int(input("Выберите файл, в который Вы хотите"
                       "перенести данные(от 1 до 2): "))
    while (answer < 1 or answer > 2) or answer == nf:
        answer = int(input("ОШИБКА! Вы ввели некорректное значение, или "
                           "выбрали тот же файл\n"
        ...
        print("Данные усешно скопированы!")